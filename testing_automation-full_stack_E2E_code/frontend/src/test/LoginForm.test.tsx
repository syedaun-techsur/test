...
// Mock fetch with proper typing for Vitest mock function
global.fetch = vi.fn();
...
describe('LoginForm', () => {
  ...
  it('shows validation error for invalid email format', async () => {
    ...
    // Submit the form via fireEvent to test validation
  ...
  it('submits form with valid credentials and calls fetch correctly', async () => {
    const user = userEvent.setup();
    const mockResponse = {
      token: 'mock-token',
