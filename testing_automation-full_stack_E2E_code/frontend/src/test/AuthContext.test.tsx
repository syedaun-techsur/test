...
const globalFetchMock = vi.fn() as unknown as jest.Mock<Promise<Response>, [RequestInfo, RequestInit?]>;
...
describe('AuthContext', () => {
  ...
  it('handles successful login', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByTestId('user')).toHaveTextContent(`${mockResponse.user.firstName} ${mockResponse.user.lastName}`);
