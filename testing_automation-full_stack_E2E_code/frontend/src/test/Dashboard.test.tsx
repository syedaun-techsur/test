...
vi.mock('../context/AuthContext', async () => {
  ...
  return {
    ...
    __mockLogout: mockLogout, // Export mockLogout for usage in tests if needed
  };
});
...
describe('Dashboard', () => {
  ...
  it('calls logout function when logout button is clicked', async () => {
    ...
    // Access the mocked logout function from useAuth mock
    // Since vi.mock does not export by default, redefine mockLogout here:
    const mockLogout = vi.fn();

    // CustomDashboard replicates the logout handler using mockLogout spy
