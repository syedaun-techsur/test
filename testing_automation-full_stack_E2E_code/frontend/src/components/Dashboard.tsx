  ...
  return (
    <div className="min-h-screen bg-gray-50" data-testid="dashboard">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <div className="bg-blue-600 w-8 h-8 rounded-lg flex items-center justify-center" aria-label="User icon">
            ...
            <div className="flex items-center space-x-4">
              <div className="text-sm text-gray-600" data-testid="welcome-message" aria-live="polite">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Welcome Section */}
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-2" aria-live="polite">
        ...
        >
          <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center" id="profile-info-heading">
        ...
        {/* Quick Actions */}
        <section className="bg-white rounded-xl shadow-sm border border-gray-200 p-6" aria-labelledby="quick-actions-heading">
          <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center" id="quick-actions-heading">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <button
              ...
              type="button"
              aria-label="Update Profile - Change your personal information"
            >
            ...
            <button
              ...
              type="button"
              aria-label="Security Settings - Manage your password and security"
            >
            ...
            <button
              ...
              type="button"
              aria-label="Notifications - Configure your notification preferences"
            >
