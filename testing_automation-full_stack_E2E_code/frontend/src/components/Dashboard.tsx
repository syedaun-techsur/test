          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8" data-testid="user-info-card">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <p className="text-gray-900 bg-gray-50 px-3 py-2 rounded-lg" data-testid="first-name">{firstName}</p>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Last Name</label>
                <p className="text-gray-900 bg-gray-50 px-3 py-2 rounded-lg" data-testid="last-name">{lastName}</p>
              </div>
              <div className="md:col-span-2">
                <label className="block text-sm font-medium text-gray-700 mb-1">Email Address</label>
                <p className="text-gray-900 bg-gray-50 px-3 py-2 rounded-lg" data-testid="email">{email}</p>
              </div>
            </div>
          </div>
        )}
