  ...
  return (
    <div className="min-h-screen bg-gray-50" data-testid="dashboard">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Stats Grid */}
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8" aria-label="Account statistics">
          {stats.map((stat, index) => {
            const Icon = stat.icon;
            return (
              <div
                key={index} // Index used as fallback key, ideally replace with unique id if available
