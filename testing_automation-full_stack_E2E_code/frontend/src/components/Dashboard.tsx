...
const Dashboard: React.FC = () => {
  ...
  // Memoize stats array for performance optimization
  const stats = useMemo(() => [
  ...
  return (
    <div className="min-h-screen bg-gray-50" data-testid="dashboard" role="main">
      {/* Header */}
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          <h3 id="profile-info-heading" className="text-lg font-semibold text-gray-900 mb-4 flex items-center">
        ...
        >
          <h3 id="quick-actions-heading" className="text-lg font-semibold text-gray-900 mb-4 flex items-center">
