...
-- Connect to the database (note: \c is psql meta-command, replace as needed in scripts)
\c auth_db;
...
-- Trigger to automatically update updated_at before any update on users table
