...
// Mock fetch with explicit type
(global as any).fetch = vi.fn() as jest.Mock;
...
const TestComponent: React.FC = () => {
  ...
  return (
    <div>
      ...
      <button data-testid="login-btn" onClick={() => void login('test@example.com', 'password123')}>
        Login
      </button>
...
describe('AuthContext', () => {
  ...
  it('provides initial state correctly', async () => {
    ...
    // Wait for loading to be false after initial effect
