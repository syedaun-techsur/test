...
public class RequestForProposalResponsesController {
    ...
    /**
     * Creates a new response and returns its ID.
     */
    @PostMapping
    ...
    public ResponseEntity<CreationDTO> createResponses(@Valid @RequestBody ResponsesRequest request) {
    ...
    /**
     * Updates an existing response by its ID.
     */
    ...
    /**
     * Retrieves a response based on the given response ID.
     */
