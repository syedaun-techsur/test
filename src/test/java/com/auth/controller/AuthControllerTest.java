...
import com.auth.exception.ValidationException;
...
/**
 * Test class for AuthController covering login, get current user, and logout endpoints.
 * Includes tests for successful and error scenarios.
 */
...
class AuthControllerTest {
    ...
    @Test
    @DisplayName("Test successful login returns correct token and user info")
    ...
    @Test
    @DisplayName("Test getting current user with valid token returns user info")
    void testGetCurrentUserSuccess() throws Exception {
        String fullToken = BEARER_PREFIX + "mock-token";
    ...
    @Test
    @DisplayName("Test getting current user with invalid token returns 401 Unauthorized")
    void testGetCurrentUserWithInvalidToken() throws Exception {
        String fullToken = BEARER_PREFIX + "invalid-token";
        String token = fullToken.substring(BEARER_PREFIX.length());
